/**
 * Created by phpstorm on 2017/5/22.
 */
/**
...
(function() {
    ...
    DrawingManager.prototype._addLabel = function (point, content) {
        //自定义--start
         ...
         if(content>1000){
         content=(content/1000).toFixed(2)+"公里";
             document.getElementById('lucd').value=content;
         //alert(content+"公里");
         }else {
         content=content+'米'
         //alert(juli+"米");
        ...
        alert('路线长度：'+content);
        content="开始地点：</br>结束地点：</br>" +
            "路线名称：</br>路线长度："+content+"</br>路线备注：";
        //自定义--end
